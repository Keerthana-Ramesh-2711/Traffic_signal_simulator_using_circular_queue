...
### Figure 1: Initial Application Screen - Empty Queue State
![Initial State](screenshot-1-initial.png)  
*Caption: Application startup showing empty circular queue (8 slots), traffic light in RED state, and simulator controls. The queue status displays "0 / 8" with "Empty: YES" indicator.*

---

### Figure 2: Traffic Light - Red Signal (Enqueue Phase)
![Red Light Enqueue](screenshot-2-red-light.png)  
*Caption: RED traffic signal illuminated with glow effect. During this 3-second phase, cars automatically join the queue at the rear position. Manual enqueue button is enabled.*

---

### Figure 3: Enqueue Operation in Progress
![Enqueue Operation](screenshot-3-enqueue.png)  
*Caption: Car being added to the queue during red light. The car icon (🚗) appears in slot with fade-in animation. Rear pointer indicates insertion position with green border.*

---

### Figure 4: Queue Partially Filled
![Partial Queue](screenshot-4-partial.png)  
*Caption: Queue with 4 out of 8 slots occupied. Front pointer (blue border) marks position 0, rear pointer (green border) at position 3. Status shows "4 / 8" with available space indicator.*

---

### Figure 5: Traffic Light - Yellow Signal (Transition Phase)
![Yellow Light](screenshot-5-yellow.png)  
*Caption: YELLOW traffic signal during 1-second transition phase. No queue operations occur during this state, preparing for green light dequeue phase.*

---

### Figure 6: Traffic Light - Green Signal (Dequeue Phase)
![Green Light Dequeue](screenshot-6-green.png)  
*Caption: GREEN traffic signal activated. During this 3-second phase, cars automatically leave from the front position. Manual dequeue button is enabled when queue has cars.*

---

### Figure 7: Dequeue Operation in Progress
![Dequeue Operation](screenshot-7-dequeue.png)  
*Caption: Car being removed from front of queue during green light. Car icon fades out from slot. Front pointer advances to next position using modulo arithmetic: (front + 1) % maxSize.*

---

### Figure 8: Circular Queue Wrap-Around Demonstration
![Wrap Around](screenshot-8-wraparound.png)  
*Caption: Demonstration of circular nature - rear pointer has wrapped from slot 7 to slot 0, while front pointer is at slot 5. This shows space reusage after dequeue operations.*

---

### Figure 9: Queue Full Condition with Overflow Notification
![Queue Full](screenshot-9-full.png)  
*Caption: All 8 slots occupied. Status displays "8 / 8" with "Full: YES" indicator. Attempting enqueue triggers toast notification "Queue is full!" Manual enqueue button is disabled.*

---

### Figure 10: Operation Log Panel
![Operation Log](screenshot-10-log.png)  
*Caption: Chronological log showing ENQUEUE operations in red and DEQUEUE operations in green, each with timestamp. Latest operations appear at top with auto-scrolling functionality.*

---

### Figure 11: Simulator Controls Panel
![Controls Panel](screenshot-11-controls.png)  
*Caption: Control interface showing Start/Pause button, Reset button, Queue Size slider (4-16 slots), Simulation Speed slider (0.5x-2x), and Manual Operation buttons.*

---

### Figure 12: Queue Empty Condition with Underflow Notification
![Queue Empty](screenshot-12-empty.png)  
*Caption: Completely empty queue state. Status shows "0 / 8" with "Empty: YES". Attempting dequeue triggers toast notification "Queue is empty!" Manual dequeue button is disabled.*

---

### Figure 13: Dynamic Queue Resizing
![Resize Queue](screenshot-13-resize.png)  
*Caption: Queue capacity changed from 8 to 12 slots. Resizing operation automatically clears existing queue and resets all pointers. New grid layout displays 12 slots.*

---

### Figure 14: High-Speed Simulation (2x Speed)
![High Speed](screenshot-14-speed.png)  
*Caption: Simulation running at 2x speed with rapid enqueue/dequeue operations. Speed slider positioned at maximum. Operation log shows high-frequency transactions.*

---

### Figure 15: Mobile Responsive View
![Mobile View](screenshot-15-mobile.png)  
*Caption: Application displayed on mobile device showing responsive layout. Components stack vertically while maintaining full functionality and readability.*
...
**Project Repository**: Available on GitHub (connected via Lovable)  
**Live Demo**: Deployed on Lovable staging environment  
